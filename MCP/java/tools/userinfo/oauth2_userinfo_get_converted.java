...
class Get_Oauth2_V2_UserinfoMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Oauth2_V2_UserinfoHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_oauth2_v2_userinfo" + queryString;
    ...
    public static MCPServer.Tool createGet_Oauth2_V2_UserinfoTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_oauth2_v2_userinfo",
            "No description available",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Oauth2_V2_UserinfoHandler(config));
    }
