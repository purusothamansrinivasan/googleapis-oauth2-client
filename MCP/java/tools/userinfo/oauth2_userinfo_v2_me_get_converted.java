...
class Get_Userinfo_V2_MeMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Userinfo_V2_MeHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_userinfo_v2_me" + queryString;
    ...
    public static MCPServer.Tool createGet_Userinfo_V2_MeTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getGet_Userinfo_V2_MeHandler(config));
    }
