...
// Import Post_Oauth2_V2_TokeninfoMCPTool - included in same package
// Import Get_Userinfo_V2_MeMCPTool - included in same package
// Import Get_Oauth2_V2_UserinfoMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Post_Oauth2_V2_TokeninfoMCPTool.createPost_Oauth2_V2_TokeninfoTool(config),
            Get_Userinfo_V2_MeMCPTool.createGet_Userinfo_V2_MeTool(config),
            Get_Oauth2_V2_UserinfoMCPTool.createGet_Oauth2_V2_UserinfoTool(config)
            );
