# Google OAuth2 API MCP Server

This MCP (Model Content Protocol) server provides access to Google OAuth2 API API functionality through HTTP, HTTPS, and STDIO transport modes.
