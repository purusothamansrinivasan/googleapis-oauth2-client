...
func Oauth2_userinfo_v2_me_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/userinfo/v2/me%s", cfg.BaseURL, queryString)
...
func CreateOauth2_userinfo_v2_me_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_userinfo_v2_me",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Oauth2_userinfo_v2_me_getHandler(cfg),
	}
}
